...
# We'll train out reenforced learning againt by letting it play against the basic agent
...
# TODO - add code to train agent ahead of time persist weights so the program starts quickly by just
# loading the persisted weights instead of re-training
